...
public class frag_user_para extends Fragment {

    Button button1, button2, button3, home;
    ListView listView;

    public frag_user_para() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_frag_user_para, container, false);
        ...
        DatabaseReference reference = FirebaseDatabase.getInstance().getReference("users").child("paramedics");
