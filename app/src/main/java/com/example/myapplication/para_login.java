...
public class para_login extends AppCompatActivity implements View.OnClickListener{
    ...
    public void openParaStatus() {
        Intent intent = new Intent(this, para_status.class);
        startActivity(intent);
    }
    ...
    private void isUser() {
        ...
        DatabaseReference reference = FirebaseDatabase.getInstance().getReference("users").child("ambulance");

        ValueEventListener postListener = new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                String IDDB = dataSnapshot.child(userEnteredID).child("plateNo").getValue().toString();
                ...
                if (userEnteredID.equals(IDDB)) {
                    ...
                    if (passwordDB.equals(userEnteredPW)) {
                        ...
                        Toast.makeText(para_login.this, "Success!", Toast.LENGTH_SHORT).show();
                        openParaStatus();
                    } else {
                        Toast.makeText(para_login.this, "Wrong ID / Password!", Toast.LENGTH_SHORT).show();
                    }
                } else {
